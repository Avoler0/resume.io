  ...
  wewigg:function () {
    return (
      <>
        ...
        제작사인 Riot Games에서 배포하는 오픈 API를 사용하여 사용자의 게임 전적, 무슨 게임 캐릭터를 선호하는지를 데이터로 알 수 있습니다.</p>
        <p>개인 프로젝트로 이 프로젝트를 진행하면서 Restful API와 비동기 처리, 데이터를 처리하는 과정을 더 깊게 이해할 수 있는 계기가 되었습니다. </p>
