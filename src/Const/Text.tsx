  ...
  wewigg:function () {
    return (
      <>
        ...
        제작사인 Riot Games에서 배포하는 오픈 API를 사용하여 사용자의 게임 전적과 전적 내 아이템과 스펠과 룬 등을 보여줍니다.</p>
        <p>개인 프로젝트로 이 프로젝트를 진행하면서 Restful API와 비동기 처리, 데이터를 처리하는 과정을 더 깊게 이해하려고 노력했고 구현에 해냈습니다.</p>
        <p>Redux를 이용하여 로그인 전역을 구현하였고, 게이머끼리 같이 플레이할 수 있도록 Json-Server 라이브러리를 사용하여 유저의 구인 광고 데이터를 저장하는 기능도 추가하였습니다.</p>
        <p><b>REST API</b> 통신 시 promise, async await을 통한 비동기 통신으로 axios를 이용하여 데이터를 내려받아 화면에 조건부로 렌더링 해주었습니다.</p>
